...
plot_cult_data       <- plot_cult_data       %+% geom_text(aes(x=V1,y=conteo,label = conteo),position = position_dodge(width = 1), hjust= -0.5)
...
plot_inst_data       <- plot_inst_data       %+% geom_text(aes(x=V1,y=conteo,label = conteo),position = position_dodge(width = 1), hjust = -0.5)
...
plot_empresa_data <- plot_empresa_data %+% geom_text(aes(x=V1,y=conteo,label = conteo),position = position_dodge(width = 1), hjust = -0.5)
...
plot_estado_data <- plot_estado_data %+% geom_text(aes(x=V1,y=conteo,label = conteo),position = position_dodge(width = 1), hjust = -0.5)
